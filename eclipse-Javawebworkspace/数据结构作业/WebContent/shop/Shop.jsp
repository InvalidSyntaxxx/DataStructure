...
<div id="top4" style="margin-top: 3px;">
 ...
 <div class="content" style="margin-top:400px;width:100%;height:1000px;overflow:scroll" >
  <div class="proRow">
  <%  GoodsInfoDao ud = new GoodsInfoDao();
    ...
    <div class="proBig">
      ...
      <a href="#">
        <div class="proBtn">
          <div class="btn">
            <p><a href="http://localhost:8080/数据结构作业/BuyGoodsServlet?goods_id=<%=goods.getId()%>">立即下单</a></p>
          </div>
          <div class="btn">
            <p><a href="http://localhost:8080/数据结构作业/AddCartServlet?goods_id=${goods.id}">加入购物车</a></p>
          </div>
        </div>
      </a>
    </div>  
