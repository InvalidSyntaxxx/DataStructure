...
<ul class="layui-nav">
  <li class="layui-nav-item ">
    ...
    <dl class="layui-nav-child">
      <dd><a href="${pageContext.request.contextPath }/UserListServlet">用户信息</a></dd>
      <dd><a href="${pageContext.request.contextPath }/GoodsListServlet">商品信息</a></dd>
  ...
  <li class="layui-nav-item"><a href="">财务报表</a></li>
